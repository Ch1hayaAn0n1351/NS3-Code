...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("tcpTypeId", "Transport protocol to use: TcpNewReno", tcpTypeId);
    ...
    bottleneckLink.SetDeviceAttribute("DataRate", StringValue("25Mbps"));
    ...
    NetDeviceContainer sender2Edge = edgeLink.Install(sender.Get(1), routers.Get(0));
    NetDeviceContainer receiver2Edge = edgeLink.Install(routers.Get(1), receiver.Get(1));
    ...
    ipv4.NewNetwork();
    Ipv4InterfaceContainer ir2 = ipv4.Assign(receiver2Edge);
    ...
    ApplicationContainer sinkApps2 = sink2.Install(receiver.Get(0));
